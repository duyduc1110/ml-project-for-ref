...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', dest='debug', default=False, type=bool, help="debug or not")
    parser.add_argument('-db', dest='database', default='localhost', type=str, help='Database host')
    args = parser.parse_args()

    conn = psg.connect(host=args.database, port='5433', database='postgres', user='postgres', password='postgres')
